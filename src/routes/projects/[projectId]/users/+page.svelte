<script lang="ts">
	...
	let { project, members, currentUserId } = $derived(data);

	const ROLE_OPTIONS = ['owner', 'admin', 'editor', 'gis', 'viewer'] as const;
...
<div class="flex h-full flex-col">
	<header class="border-b border-surface-200 p-4 dark:border-surface-700">
		...
		<p class="mt-1 text-sm text-surface-500">{project.projectname}</p>
	</header>
